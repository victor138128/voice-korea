        ...
        div {
            ...
            if (ctrl.enable_modal)() {
                AttributeAddModal {
                    translates: ModalTranslates {
                        search_hint: translates.search_hint.clone(),
                        search_result: translates.search_result.clone(),
                        add_attribute: translates.add_attribute.clone(),
                        selected_attribute: translates.selected_attribute.clone(),
            ...
            div {
                ...
                div {
                    ...
                    div {
                    class: "flex flex-col w-full justify-start items-start max-w-[1200px] h-min rounded-[10px] border-solid border border-[#9f9f9f] bg-white px-[33px] py-[55px]",
                        div {
                            class: "text-[#2168c3] font-semibold text-[30px] mb-[45px]",
                            {translates.attribute_status}
                        },
                        div {
                            class: "flex flex-col w-full justify-start items-start mb-[60px]",
                            div {
                            ...
                            div {
                                ...
                                div {
                                    class: "flex flex-row w-[200px] h-[50px] justify-center items-center rounded-3xl bg-[#d6d6d6] border-[1px] border-[#c8c8c8]",
                                    div {
                                        class: "pr-[5px] ",
                                        Add {
                                            width: "22",
                        ...
                        AttributeTable {
                            translates: TabelTranslates {
                                ...
                                tabel_label: translates.tabel_label,
                            },
...
fn AttributeTable(translates: TabelTranslates, search_attributes: Vec<SelectAttribute>) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: "text-[black] font-semibold text-[22px] mb-[35px]",
                {translates.search_result}
            }
            div {
                class: "flex flex-col w-full h-min justify-start items-start mb-[10px]",
                div {
                    class: "flex flex-row w-full justify-start items-start",
                    div {
                        class: "w-full min-w-[50px] max-w-[100px] h-[25px] pl-[17px]",
                        div {
                            class: "text-[black] font-semibold text-[18px]",
                            {translates.tabel_label[0].clone()}
                        }
                    }
                    div {
                        class: "w-full min-w-[50px] max-w-[150px] h-[25px] pl-[15px]",
                        div {
                            class: "text-[black] font-semibold text-[18px]",
            ...
            for (i, attribute) in search_attributes.iter().enumerate() {
                div {
                    class: "flex flex-row w-full h-[55px] justify-start items-center rounded-xl bg-white border-[1px] border-[#9f9f9f] mb-[5px]",
                    div {
                        class: "w-full min-w-[50px] max-w-[100px] h-[25px] pl-[22px]",
                        div {
                            class: "text-[black] font-semibold text-[20px]",
                            {i.to_string()}
                        }
                    }
                    div {
