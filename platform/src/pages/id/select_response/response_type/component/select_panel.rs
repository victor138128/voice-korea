        ...
        div {
            ...
            div {
                ...
                div {
                    ...
                    div {
                        class: "flex flex-row w-full justify-end items-end mb-[30px] mt-[30px]",
                        div {
...
pub fn PanelTable(
    ...
    rsx! {
        div {
            ...
            div {
                class: "flex flex-row w-full h-full justify-between items-end mb-[10px]",
                div {
                    class: "flex flex-row",
                    div {
                        class: "text-xl font-normal text-[#5e5e5e] mr-[5px]",
                        {format!("{} : ", search_results)}
                    }
                    //FIXME: fix to real result
                    div {
                        class: "text-xl font-semibold text-[#2168c3]",
                        "250명"
                    }
                }
                div {
                        ...
                        div {
                            ...
                            div {
                                ...
                                div {
                                    class: "pr-[20px]",
                                    onclick: move |_| {
                                        let value = ctrl.get_select_panels().contains(&(i as u64));
                                        ctrl.change_select_panels(i as u64, !value);
                                    },
                                    img {
                                        class: "pr-[10px]",
                                        src: if ctrl.get_select_panels().contains(&(i as u64)) {asset!("public/images/enable_check.png")} else {asset!("public/images/not_enable_check.png")},
                                        alt: "check"
                                    }
                                }
                                div {
...
pub fn AttributeTable(
    ...
    rsx! {
        div {
            class: "flex flex-col justify-start items-start w-full",
            div {
                class: "flex flex-row w-full h-full justify-end items-end mb-[10px]",
                div {
                    class: "text-xl font-normal text-[#5e5e5e] mr-[3px]",
                    "현재"
                }
                        ...
                        div {
                            ...
                            div {
                                ...
                                div {
                                    ...
                                    {format!("{} {}", selection_panel_groups, i + 1)}
                                }
                                div {
                                    class: "w-[190px] text-[#5e5e5e] font-normal text-[20px] pr-[20px]",
                                    {d.country.clone()}
                            ...
                            div {
                                ...
                                div {
                                    class: "text-black font-medium text-[20px] mr-[5px]",
                                    "총 "
                                }
                                div {
                                    class: "text-[#1e5eaf] font-medium text-[20px]",
                                    {d.value.to_string()}
                                }
                                div {
