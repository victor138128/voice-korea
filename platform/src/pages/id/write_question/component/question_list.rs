    ...
    rsx! {
        Fragment {
            ...
            div {
                ...
                Fragment {
                    div { class: "w-full pl-[30px] pr-[40px] pt-[20px] pb-[20px]",
                        for i in 0..survey.questions.len() {
                            if !keys.contains(&i) {
                                div {
                                    ...
                                    div { class: "font-semibold text-xl text-[#4c4c4c]",
                ...
                div { class: "flex flex-row w-[200px] h-[50px] rounded-[20px] bg-[#d6d6d6] justify-center items-center",
                    img {
