    ...
    rsx! {
        div {
            ...
            div {
                ...
                "{translates.find_email}"
            }
            if ctrl.get_email_address() == "" {
                FindEmail {
                    lang: props.lang.clone(),
                    ctrl: ctrl,
                    name_label: translates.name_label.clone(),
                    name_hint: translates.name_hint.clone(),
                    phone_label: translates.phone_label.clone(),
                    phone_hint: translates.phone_hint.clone(),
                    send_authentication_number: translates.send_authentication_number.clone(),
                    authentication_number: translates.authentication_number.clone(),
                    authentication_number_description: translates.authentication_number_description.clone(),
                    check_title: translates.check_title.clone(),
                    check_description: translates.check_description.clone(),
                    find_email: translates.find_email.clone(),
                }
            } else {
                GetEmail {
                    lang: props.lang.clone(),
...
pub fn GetEmail(props: GetEmailProps) -> Element {
    ...
    rsx! {
        div {
            ...
            div {
                class: "flex flex-col w-full h-full items-start justify-start pb-[30px]",
                div {
                    class: "text-[#636363] font-normal text-[24px] mb-[30px]",
                    {props.get_email_description}
                }
                div {
                    class: "flex flex-col w-full justify-start items-start mb-[490px]",
                    Row {
